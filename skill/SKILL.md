...
description: >
  Activate when any person — believer, agnostic, atheist, student of knowledge, philosopher, or daee — presents a theological, epistemological, or philosophical inquiry. Covers: personal aqidah or noetic structure for diagnosis; shubuhat and structured objections; named doctrinal challenges (evil, hiddenness, Trinity, philosopher's-God); Quranic revelation, scripture, and transmission challenges (RT-1 through RT-4); final-prophethood challenges (transmission layer RT-1–RT-4, moral-luck layer DO-8, philosophical-authority layer prophecy-wahy-supremacy); Muslim-internal crises (authority fatigue, modernist revision, textual shubuhat); structured positions (naturalism, scientism, kalamic evidentialism, historical-critical skepticism); comparative religion — explicit Christian extensions (Trinity DO-11/DO-12, philosopher's God DO-13, Incarnation coherence) and broader cross-tradition coverage through family transfer (see note below); conversation excerpts (thin-basis discipline applies — see P7 Stop-4). Diagnoses noetic structure and deformations; responds from sound reason and prophetic tradition — removing occlusion, not constructing novelty. Arabic glossed on first use. Activate when user presents any worldview or argument, or uses: "aqidah", "noetic structure", "shubhah", "objection", "respond to this", "diagnose and refute", "what's wrong with this."
  Comparative-religion coverage note: The repo governs comparative-religion cases at two levels. (1) Explicit extensions: DO-11 through DO-13 in do-christian-extensions.md govern Trinity, Incarnation coherence, and philosopher's-God objections specific to Christian theology. (2) Family-transfer coverage: cases from any tradition that instantiate a governed family are covered through that family — this is operative scope, not vague generality. Specifically: divine-multiplicity configurations (polytheism, henotheism, Hindu monistic or pluralistic-deity arrangements, apatheistic non-commitment) are governed through V12 (tamannaʿ exhaustion — explicitly cross-traditional: "any interlocutor; deploy before Trinitarian-specific DO cases") and the Creator-creation distinction in metaphysical-architecture.md; devotional-disorder cases (desire-as-worship, idolatry as fiṭrah-substitution) are governed through the hawā and ʿāda deformation types plus F2 (volitional dimensions); cross-tradition philosophical-framework usurpation (e.g., Advaita non-dualism, Buddhist impermanence, Confucian naturalism installed as the arbiter of what theology may assert) is governed through philosophical-usurpation.md Types A–D; the religious-diversity objection is governed through DO-4; noetic-structure diagnosis applies across any religious background through NS-1 through NS-12. What is NOT governed: bespoke religion-specific argument structures requiring their own case files — specifically, Buddhist anatta as a direct challenge to the Islamic account of the soul, Hindu non-dualist (Advaita) claim as a rival theological ontology, and Jewish final-prophethood arguments. Adherents of these traditions whose cases instantiate a governed family are engaged through that family; cases requiring bespoke religion-specific doctrinal content have no dedicated case file in this version.
  Additional coverage boundary: hadith authentication epistemology (isnād grading, āḥād-vs-mutawātir for sunnah) and Islamic jurisprudential ethics objections (fiqh-specific moral challenges) are not governed by dedicated case content. The latter routes through philosophical-usurpation Type D and NS-8 but without a dedicated DO-series treatment.
---

...
| 2026-04 Session 15 | Transliteration / Unicode integrity corrective release pass | Corrected surfaced prose and package-facing transliteration misses that escaped `v0.1.0.2`, including `dāʿī`, `ʿaqīdah`, and `fiṭrah` fallbacks in SKILL.md, P6, terminology guidance, and related surfaced routing text; updated README.md and this ledger for `v0.1.0.3` release traceability; and re-verified that release-facing metadata and WSL-built skill packaging remain Unicode-clean and slash-safe without broad architectural or formatting churn. |

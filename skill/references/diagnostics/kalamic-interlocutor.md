...
**1. Internal Islamic debate:** Show that the framework grounded in sound reason is the
more coherent Islamic epistemology — that it better accounts for the prophetic method,
is more faithful to the Qurʾānic account of how human beings come to know God, and
avoids the epistemic problems generated by the restriction of foundational knowledge
to the kalāmic class.

**2. The broader point:** The kalāmic framework, by importing a historically contingent
model of what counts as knowledge, inadvertently produced a form of contaminated
rationality (bidʿī ʿaqlī) within the tradition itself — a conception of religious
knowledge derived not from revelation but from the Islamicized Hellenistic philosophical
tradition. This is not anti-rational; it is the claim that genuine reason (ʿaql ṣarīḥ)
always agrees with genuine revelation (naql ṣaḥīḥ), and that the kalāmic framework has
substituted a contingent historical conception of reason for the real thing.

## The Māturīdī Middle Position — Distinct Engagement Path

The Māturīdī tradition occupies a position between the hard Muʿtazilī requirement and
the account grounded in sound reason. Māturīdī thinkers allow that wujūb al-naẓar may
be communal rather than individual — the scholarly community bears the burden, the
ordinary believer may rely on the community's demonstration. Some Māturīdī thinkers
additionally allow non-propositional evidence (religious experience, Qurʾānic encounter,
miraculous testimony) as epistemically valid.

An interlocutor formed in the Māturīdī tradition is neither a hard evidentialist nor
aligned with the position grounded in sound reason. The engagement path:

**Affirm the Māturīdī concession:** The communal obligation reading weakens the
individual requirement; the allowance of non-propositional evidence already opens space
for the fiṭrah account. Work with these concessions, not against them.
...
standing? If reliance on the community's demonstration is sufficient, the belief's
warrant is grounded in something other than the believer's own inferential process —
which is precisely what the externalist account of the fiṭrah holds. The Māturīdī
position quietly concedes the externalist point while retaining the vocabulary of
obligation.

**Show the fiṭrah account is more honest:** Rather than constructing a complex structure
of individual vs. communal obligations, the fiṭrah account simply names what is actually
happening epistemologically — the fiṭrah produces warranted belief directly when
functioning correctly, and the scholarly community's arguments serve to restore the
fiṭrah's operation when it has been corrupted, not to supply what the fiṭrah lacks.

...
| خلق | Khalq | Creation — the external productive origination of something ontologically distinct from Allah; a ḥādith thing externally produced and therefore separate from the divine essence. All makhlūq is muḥdath, but not all muḥdath is makhlūq. The Muʿtazilī error was treating ḥudūth as sufficient for khalq; the Salafī refutation is that ḥawādith (temporally originating events) subsisting in the divine essence are ḥādith but not makhlūq, because they are not external productions. |
| صفة قائمة بالذات | Ṣifa qāʾima bi-dhātihi | An attribute subsisting in the divine essence — its particular acts or occurrences (ḥawādith) are ḥādith (temporally originating) yet not makhlūq, because they subsist in God rather than being externally produced. The ṣifa itself is eternal; the specific acts are generated by divine will (al-umūr al-ikhtiyāriyya al-qāʾima bi-dhātihi). This node separates three positions: (a) Salafī — ṣifa eternal, particular acts ḥādith but not makhlūq; (b) Ashʿarī — denies ḥudūth of the acts altogether, holding an eternal kalām nafsī with the verbal expression (lafẓī) created but external; (c) Muʿtazilī — affirms ḥudūth and infers makhlūq, treating the Qurʾān as a created external object. |

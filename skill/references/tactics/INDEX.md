...
|------|----------|----------|-----------------|-----------------|
| `references/tactics/E1-broadening-evidence.md` | Evidentialist | The interlocutor claims there is no evidence | The real issue is still a narrow evidential criterion rather than absence of evidence altogether | E2, E3, V5 |
| `references/tactics/E2-inferential-criterion.md` | Evidentialist | Inferential argument is being treated as necessary for warrant | The case is already operating comfortably with basic belief | V3, R1 |
| `references/tactics/E3-cumulative-case.md` | Evidentialist | Bounded cumulative assembly is needed after upstream clearing | One sharp upstream move still dominates or the added routes would be redundant | E1, V5, V6 |

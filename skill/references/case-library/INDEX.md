...
|-----------------|------|-----------------|-----------------|
| NS-1 through NS-5 | `case-library/noetic-profiles.md` | You only have a topic, not a recognizable noetic type | V1, M5, V2, M3 |
...
| DO-10 | Three-tiered epistemological structure | Fitrah -> khabar -> nazar ordering | Flattening all knowledge into a single inferential tier |
| DO-11 | Trinity from divine perfection | Distinguish perfection from one mode of exercise | Smuggling revelation-level claims into bare perfection reasoning |
| DO-12 | Logical problem of the Trinity | Identify the model first | Letting "mystery" stand in for coherence |
| DO-13 | Philosopher's God vs. God of revelation | Refuse the static-deity collapse | Treating abstraction as purification |

...
> do not use when: NS code is still provisional — route through mixed-case-handling.md; do not confuse with NS-6 (see minimal-pair discriminator in profiles/INDEX.md)
> paired files: E2 (inferential criterion); V3 (regress dissolution); reason-disambiguation.md Category 3

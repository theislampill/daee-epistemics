...
| `references/techniques/V9-necessary-knowledge-priority.md` | Necessity-over-inference control | A discursive argument contradicts universally held fitri knowledge | The argument is merely unpopular or difficult, not anti-necessary | E4, DO-7, DO-9 |
...
| `references/techniques/V11-taqlid-transition.md` | Structured transition from `taqlid` to `tahqiq` | The subject has recognized their position is held by `taqlid` and is willing to transition | The subject is still defending the `taqlid`; V7 must precede V11 | V7, `symmetric-taqlid-check.md`, V9 |

...
- Burden-Cycle 2: independent lordship / worship-status plurality after relative-identity model test -> independent lordship / worship-status plurality; V12 tamanu check -> the case separates predication failure from independent-lordship pressure.

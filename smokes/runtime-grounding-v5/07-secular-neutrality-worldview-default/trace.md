...
## Owner anchors used
- foreign-premise-detection.md §Common tribunal types
- V2-reconstituting-reason.md §Three steps
- M1-self-refutation.md §Stage 3
- M8-reductio.md §Informal Reductio

## Causal proof
- Burden-Cycle 1: secular neutrality / worldview-default burden -> foreign-premise detection with V2 reason restoration -> the claim must now defend its own authority rather than use neutral as a shield.
- Burden-Cycle 2: self-refutation / reductio pressure in secular neutrality claim -> M1 self-refutation and M8 reductio -> the public/private split is seen as a substantive authority rule requiring warrant.

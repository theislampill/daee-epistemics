...
## Causal proof
- Burden-Cycle 1: moral protest and hiddenness criterion -> moral tribunal detection with register-sensitive bounded response -> suffering remains morally serious, but the inference to divine unworthiness is blocked at the criterion level.
- Burden-Cycle 2: moral authority behind the protest -> M8 reductio / M1 self-refutation pressure -> the response now distinguishes real moral pain from an unwarranted authority claim.

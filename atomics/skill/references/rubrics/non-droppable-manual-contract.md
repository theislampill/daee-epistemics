---
id: non-droppable-manual-contract
module_class: governance
canonical_path: skill/references/rubrics/non-droppable-manual-contract.md
contract_version: "0.4.0.0"
load_when:
  - any hard, source-worldview, named-authority, or multi-burden manual/default output about to be rendered
routing_effects:
  - governs the non-droppable default render shape, ACT grammar, owner floor, field_witness key list, and MRP block grammar carried into the compiled runtime

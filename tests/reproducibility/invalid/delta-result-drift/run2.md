...
B1 (root)
Terminal states:
B1: landed / M1 / root pressure renamed
MRP resultants:
...
field_witness
{
  ...
  "B_MRP": [],
  "B_total": ["B1"],
  "nodes": [{"id": "B1", "type": "burden", "owners": ["M1"], "state": "landed"}],
  "edges": [],
  ...
  "owner_activations": [
    {"source": "B1", "target": "B1", "owner": "M1", "operation": "repair", "pressure": "root-pressure", "body_ref": "B1_1", "delta": "Delta B1:root renamed", "land": "Land(B1)+"}
  ],
  "normalized_activation_record": {
    ...
    "burden_floor": ["B1"],
    "per_burden": [
      {"burden_id": "B1", "owner_id": "M1", "operation": "repair", "delta_result": "root renamed", "mrp_route_result_type": "no_new_resultant", "terminal_state": "landed", "generation_depth": 0}
    ]
  },
  "coverage_proof": {

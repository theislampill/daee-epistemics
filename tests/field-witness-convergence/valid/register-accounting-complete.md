...
The scoped pass accounts for every live register with a register-typed floor burden.
...
field_witness
{
  ...
  "owner_activations": [
    {"source": "B1", "target": "B1", "owner": "FPD", "operation": "foreign-premise-detection", "pressure": "authority", "body_ref": "B1_1", "delta": "Delta B1:authority bounded", "land": "Land(B1)+"},
    {"source": "MRP(B1)", "target": "B2", "owner": "M7", "operation": "definition-anchor", "pressure": "carrier", "body_ref": "B2_1", "delta": "Delta B2:carrier decomposed", "land": "Land(B2)+"},

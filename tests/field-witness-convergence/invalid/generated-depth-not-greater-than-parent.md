...
B3: held-with-reason / P7 / generated boundary held
MRP resultants:
...
field_witness
{
  ...
  "nodes": [
    ...
    {"id": "B3", "type": "generated_burden", "generated_by": "MRP(B2)", "generation_depth": 0, "state": "held-with-reason"}
  ],
  "edges": [{"from": "B1", "to": "B2"}, {"from": "B2", "to": "B3"}],
  "generated_burdens": [
    {"id": "B3", "generated_by": "MRP(B2)", "generation_depth": 0, "reason": "boundary pressure remained after B2 landed"}
  ],
  "mrp_resultants": [
  ...
  "terminal_states": {"B1": "landed", "B2": "landed", "B3": "held-with-reason"},
  ...
  "owner_activations": [
    ...
    {"source": "MRP(B2)", "target": "B3", "owner": "P7", "operation": "bound", "body_ref": "B3_1", "delta": "Delta B3:boundary held", "land": "Land(B3)+"}
  ],
  "coverage_proof": {
    "initial_burden_set": ["B1", "B2"],
    "terminal_states": {"B1": "landed", "B2": "landed", "B3": "held-with-reason"},
    "dependency_graph": {"nodes": ["B1", "B2", "B3"], "edges": [["B1", "B2"], ["B2", "B3"]], "roots": ["B1"], "acyclic": true},

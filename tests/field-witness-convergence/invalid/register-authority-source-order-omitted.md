...
- live registers: authority/source-order and kappa are live.
- B_LA = {B1}
- B_MRP = {}
...
Land(B1): dependency chain landed.
...
B1 (root)
Terminal states:
B1: landed / M8 / dependency chain landed
MRP resultants:
...
field_witness
{
  ...
  "B_total": ["B1"],
  "nodes": [
    {"id": "B1", "type": "burden", "register_types": ["kappa"], "state": "landed"}
  ],
  "edges": [],
  "mrp_resultants": [

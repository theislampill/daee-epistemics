daee-epistemics — T_lang uptake-free closure counterpart (minimal pair with invalid/uptake-assertion.md)
...
The reserve criterion is exposed and the proof-carousel pressure is bounded; the reserve criterion is returned to its proper place.

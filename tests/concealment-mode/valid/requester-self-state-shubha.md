...
field: MUSLIM-INTERNAL CLARIFICATION
user task: EXPLAIN
...
- diagnostic_target: requester-self-state
- concealment_applies_to: requester
- requester_posture: Muslim asking about my own shubhah
- read status: sincere clarification under doubt-pressure
...
The requester self-state is the target, but the route is clarification rather than refusal.

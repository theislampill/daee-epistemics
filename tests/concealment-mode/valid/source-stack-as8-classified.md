...
- read status: a source stack is being used ambiguously as evidence, prestige, identity signal, and contrast
...
Layer B holds the source parade and classifies each source's function before any content answer is released.

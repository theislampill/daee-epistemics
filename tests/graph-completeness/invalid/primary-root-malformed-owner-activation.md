...
```json
{
  ...
  "owner_activations": [
    {"source": "B1", "target": "B1", "owner": "generic-owner", "operation": "validated state", "pressure": "local criterion", "body_ref": "B9_9", "delta": "Delta B1:criterion anchored", "land": "Land(B9)+"}
  ],
  "coverage_proof": {

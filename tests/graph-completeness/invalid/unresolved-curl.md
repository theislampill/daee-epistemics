...
field_witness
{
  ...
  "formal_reread_states": [
    {"source_burden": "B1", "prior_land": "Land(B1)", "delta": "Delta B1: landed", "reread": "R(H,Delta)", "route_gradient": "STOP", "divergence_state": "neutral", "curl_state": "non-null", "route_result_type": "no_new_resultant", "mrp_resultant": "stable -> no new graph edge", "graph_delta": "none", "preemption_basis": "none", "route": "STOP"}
  ],

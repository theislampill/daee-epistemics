...
field_witness
{
  ...
  "formal_reread_states": [
    {
      ...
      "escape_routes_checked": [
        {"type": "hidden-framework-recoil", "live": true, "disposition": "generated_burden_instantiation", "target_burden": "B2", "basis": "framework pressure"}
      ]
    }
  ],
  ...
  "owner_activations": [
    ...
    {"source": "MRP(B1)", "target": "B2", "owner": "P7", "operation": "bound", "pressure": "hidden-framework recoil", "body_ref": "B2_1", "delta": "Delta B2:route bounded", "land": "Land(B2)+"}
  ],
  "coverage_proof": {

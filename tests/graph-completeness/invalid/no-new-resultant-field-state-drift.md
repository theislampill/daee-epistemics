  ...
  "formal_reread_states": [
    {
      ...
      "reread": "R(H,Delta)",
      "route_gradient": "STOP asserted while proof field state contradicts the formal state.",
      ...
      "no_new_resultant_proof": {
        ...
        "field_state_at_stop": {"divergence": "non-neutral", "curl": "null", "b_live": "empty", "kappa_residual": 0},
        "stop_licensed": true
      }
    }
  ],

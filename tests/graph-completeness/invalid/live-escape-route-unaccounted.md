  ...
  "formal_reread_states": [
    {
      ...
      "escape_routes_checked": [
        {"type": "proof-carousel", "live": true, "basis": "A proof-carousel route is live but no burden, HOLD, PARTIAL, RECURSE, LoopBreak, or non-load-bearing proof accounts for it."}
      ]
    }
  ],

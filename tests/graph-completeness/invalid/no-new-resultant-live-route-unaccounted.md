  ...
  "formal_reread_states": [
    {
      ...
      "reread": "R(H,Delta)",
      "route_gradient": "STOP asserted while a live escape route points nowhere in the trace.",
      ...
      "no_new_resultant_proof": {
        "escape_routes_checked": [
          {"type": "closure-boundary-immunity", "live": true, "disposition": "generated_burden_instantiation", "target_burden": "B9", "basis": "A live route is named but B9 is absent."},

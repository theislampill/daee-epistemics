...
released from fitrah and sound reason orientation after the field witness has already been
printed.

## Closing Formulation
The scoped pass is complete because the single initial burden landed, and the closing frame
returns to fitrah with sound reason rather than claiming uptake.

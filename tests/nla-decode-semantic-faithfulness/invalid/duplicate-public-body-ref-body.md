...
### B1_1[M9] - retained category consequence
Target: retained-category consequence.
Operation: repair the consequence that follows after the predicate transfer is blocked.
Result/state-change: retained category consequence clarified.
Contribution-to-Land(B1): This extra detail must not become a second dereferenceable body for B1_1.

...
Result/state-change: analogy consequence exposed; arithmetic analogy is traced instead.
Contribution-to-Land(B1): This exposes analogy consequence and contributes to Land(B1).

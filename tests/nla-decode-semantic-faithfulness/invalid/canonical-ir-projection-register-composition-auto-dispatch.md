...
N-frame: register-composition-auto-dispatch-canary
...
field_witness
{
  ...
  "normalized_activation_record": {
    "n_frame": "register-composition-auto-dispatch-canary",
    "live_registers": ["heart", "xi", "Omega", "mu", "kappa"],
    "burden_floor": ["B1"],
    "per_burden": [
  ...
  "canonical_ir_projection": {
    ...
    "register_composition": {
      ...
      "sigma_boundary": {"present": true, "inside_hard_registers": false, "role": "sigma is outside the hard-register object"},

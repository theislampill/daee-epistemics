...
Operation: repair predicate transfer.
...
field_witness
{
  ...
  "B_total": ["B1"],
  "owner_activations": [
    {"source": "B1", "target": "B1", "owner": "M8", "operation": "repair", "pressure": "predicate-transfer", "body_ref": "B1_1", "delta": "ΔB1:predicate transfer blocked", "land": "Land(B1)+"}
  ],
  "coverage_proof": {

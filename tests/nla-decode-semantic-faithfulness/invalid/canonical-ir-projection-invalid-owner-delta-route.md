...
field_witness
{
  ...
  "canonical_ir_projection": {
    ...
    "burden_floor": ["B1"],
    "per_burden": [
      {"burden_id": "B1", "owner_id": "invented-owner", "operation": "repair", "delta_result": "source-order-repaired", "mrp_route_result_type": "advice_only", "terminal_state": "landed", "generation_depth": 0}
    ],
    "diagnostic_completeness": {"live_registers": ["Omega"], "coverage": {"Omega": ["B1"]}, "complete": true}
  }
}

...
Operation: source-order bounds the scientific-explanations-only-knowledge-source pressure by assigning science to its proper source lane.
...
TTP Operation Body:
The operation source-order bounds the source claim and prevents it from becoming the whole tribunal for knowledge.
...
field_witness
{
  ...
  "canonical_ir_projection": {
    ...
    "hard_registers": {
      "heart": {"state": "non_live", "functions": [], "basis": [], "non_live_reason": "not live"},
      "xi": {"state": "live", "functions": ["warrant-authority"], "basis": ["source rule controls warrant"]},
      "Omega": {"state": "non_live", "functions": [], "basis": [], "non_live_reason": "not live"},
      "mu": {"state": "non_live", "functions": [], "basis": [], "non_live_reason": "not live"},
      "kappa": {"state": "live", "functions": ["closure-boundary"], "basis": ["closure depends on source-order landing"]}
    },
    "n_frame": "science-only-source-order-warrant",
    "burden_floor": ["B1"],
    "per_burden": [

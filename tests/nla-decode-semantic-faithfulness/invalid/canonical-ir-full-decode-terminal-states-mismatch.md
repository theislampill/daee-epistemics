...
field_witness
{
  ...
  "canonical_ir_projection": {
    ...
    "emission_policy": {
      "schema": "b5-full-ir-runtime-emission-v1",
      "mode": "default-runtime-when-proof-class-closure-claimed",
      "source_evidence": [
        "visible_noetic_field_opening",
        "visible_layer_a_diagnostic_ir_header",
        "field_witness.canonical_ir_projection",
      ...
      "proof_class_closure_only": true,
      "requires_projection": true,
      "requires_decoded_ir": true,
      "requires_full_ir_decode": true,
      "visible_opening_header_required": true,
      "legacy_schema_light_absent_valid": true,
      "public_prose_replacement": false,
      "arbitrary_nl_ir_parser_claim": false,
      "t_lang_uptake_claim": false
    },
    "decoded_ir": {
    ...
    "full_ir_decode": {
      ...
      "terminal_states": {"B1": "landed", "B2": "hold_partial"},

...
class Gate14RegistryContractTests(unittest.TestCase):
    ...
    def test_ci_registry_accounts_for_required_task2_through_task7_integration_commands(self) -> None:
        ...
        expected = {
            ...
            "task6-single-call-envelope-contract": "python tests/single-call-stage-envelope/test_contract.py",
            "task6-b5-current-adapter-contract": "python tests/b5-current-witness-adapter/test_contract.py",
            "task6-producer-capture-finalization-contract": "python tests/producer-capture-finalization/test_contract.py",
            "task6-single-call-stage-finalization-contract": "python tests/single-call-stage-finalization/test_contract.py",
            "task6-producer-structural-completion-contract": "python tests/producer-structural-completion/test_contract.py",
            "task6-initial-assessment-barrier-contract": "python tests/initial-assessment-barrier/test_contract.py",

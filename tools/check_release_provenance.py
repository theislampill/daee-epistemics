...
def write_release_body(path: Path, manifest: dict[str, object]) -> None:
    ...
    lines = [
        ...
        "- generated-burden / notation hotfix with deterministic fixtures/checker;",
        "- mojibake guard/fix for parseable governance notation;",
        "- package-bound artifact validation.",
        "",
        "## Generated-burden / notation hotfix",
        "",
        "This refreshed v0.4.3.0 asset adds deterministic guards for MRP-generated burden",
        "instantiation and canonical burden notation.",
        "",
        "MRP route-result types now distinguish:",
        "",
        ...
        "- `hold_partial`",
        "",
        "Notation guidance is normalized toward:",
        "",
        "- `ⁿB` for burden n",
        "- `ⁿBᵢ` for submove i under burden n",
        "- `MRP(ⁿB)` for reread-pressure resultant",
        "- `ⁿB → ⁿ⁺¹B` for dependency/resultant graph edge",
        "",
        "Evidence boundary: the generated-burden behavior is covered by deterministic",
        "fixtures/checkers in this release. A fresh hosted Smoke 7 model-output proof was not run",
        "in this pass.",
        "",
        "## Artifact",
        "",
...
def check_release_body(path: Path, manifest: dict[str, object], errors: list[str]) -> None:
    ...
    required = {
        ...
        "generated-burden caveat": "fresh hosted Smoke 7 model-output proof was not run",

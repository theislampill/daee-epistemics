...
GENERATED_DOC_TOKENS = {
    "docs/index.html": [
        ...
        "gate + ∇ route pressure",
        "ⁿB burden selected",
        "Land(ⁿB) + Δ state update",
        "LoopBreak if circular dependency remains",
        "∇·T / ∇×T field diagnostics",
        ...
        "target-explicit post-Δ field pressure",
        "R(H,Δ) rereads the changed field",
        "𝒞(Ψᴺ) licenses closure as field condition",
        "T_lang: Ψᴺ ⇢ Ψᴵ marks public coupling",
        "𝒞(Ψᴺ)",
        "T_lang: Ψᴺ ⇢ Ψᴵ",
    ],

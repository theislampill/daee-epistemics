...
def main() -> int:
    ...
    required_js = {
        ...
        "case headline rendered": "CASE: prooftext / source-reading reply",
        "case map badge": "What this map is about",
        "generic prooftext visible context": "A prooftext or source-reading reply",
        "generic verdict headline": "Verdict:",
        "baseline ledger visual": "B_LA",
        "generated ledger visual": "B_MRP",
        "route gradient visual": "Route-gradient",
        "del-dot visual": "del-dot",
        "del-cross visual": "del-cross",

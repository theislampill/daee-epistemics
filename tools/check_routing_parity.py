...
OWNER_CLUSTER_BUNDLES = {
    ...
    "core-ir": "references/runtime-core-ir.md",
    "core-pipeline": "references/runtime-core-pipeline.md",
    "core-recursion": "references/runtime-core-recursion.md",
    "core-routing": "references/runtime-core-routing.md",
    "shard-ir-support": "references/runtime-shard-ir-support.md",
    "shard-diagnostic": "references/runtime-shard-diagnostic.md",
    "shard-audit": "references/runtime-shard-audit.md",
    "shard-thesis": "references/runtime-shard-thesis.md",
    "shard-restoration": "references/runtime-shard-restoration.md",
    "shard-output-release": "references/runtime-shard-output-release.md",
    "shard-render-contract": "references/runtime-shard-render-contract.md",

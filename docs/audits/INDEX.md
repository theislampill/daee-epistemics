...
| `docs/audits/v0.4.2.0-docs-index-design-refinement-implementation.md` | CURRENT-CANDIDATE | Implements P1 docs/index design hierarchy refinements, component roles, Reference source-browser, Owners workspace, Theory hierarchy, visual QA runbook, notation preservation, and checker hardening. |

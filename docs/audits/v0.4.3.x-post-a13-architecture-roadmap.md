...
| Decision | Why Protected | Depends On | Smallest Safe Prep Work If Opened | Recommendation |
|---|---|---|---|---|
| A.13.3 runtime/default hard-register emission | It changes the runtime/default governed-output contract and may affect retained schema-light compatibility. | A.13.1, A.13.2, diagnostic IR source, generated runtime policy, IR/checker fixtures. | Owner-opened docs-only A.13.3 decision-prep naming source owners, fixtures, compatibility gates, and stop conditions. | Next protected owner decision. |
| Full IR decode / B.5 hard-register decode | It would upgrade bounded ACT/body reconstruction into IR-state reconstruction and risks overclaim. | A.13.3 emission/projection policy, B.1/B.2/B.4 proof surfaces, hard-register NAR state. | B.5 full IR decode preflight after owner-opened A.13.3 policy is clear. | Wait until A.13.3 prep defines the input source. |
| Register-composition / D.3 residuals | It may cross from schema-light D.3 into hard-register/runtime composition. | A.13.2, fixture 63, D.3 concealment mode, future A.13.3 policy. | Owner-opened fixture 63 / register-composition decision-prep. | Treat fixture 62 as closed; use fixture 63 for future composition. |
...
2. Owner may open A.13.3 decision-prep only.
3. After owner-opened A.13.3 policy is clear, owner may open B.5 full IR
   decode preflight.
4. Owner may decide fixture 63/register-composition disposition under
   A.13-adjacent scope.

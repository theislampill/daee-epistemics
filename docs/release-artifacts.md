...
| Size | `622900` bytes |
| Entries | `20` |
| Source commit recorded in provenance | Final release-fix source commit generated by `tools/check_release_provenance.py --write-manifest` and package provenance |
...
generalization evidence only, not a full replacement for the Repair14 behavioral proof.
